...
RB_CMD="s_idx=${S_IDX};exp_path=\"/storage1/fs1/michael.landis/Active/hawaiian_simulations_param/experiment1/\";source(\"/storage1/fs1/michael.landis/Active/hawaiian_simulations_param/scripts/rev_scripts/inf.Rev\");"
